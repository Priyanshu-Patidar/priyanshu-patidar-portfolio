...
export const EMAILJS_CONFIG = {
  ...
  NOTIFICATION_TEMPLATE_ID: (import.meta as any).env?.VITE_EMAILJS_NOTIFICATION_TEMPLATE_ID || 'YOUR_NOTIFICATION_TEMPLATE_ID',
  AUTOREPLY_TEMPLATE_ID: (import.meta as any).env?.VITE_EMAILJS_AUTOREPLY_TEMPLATE_ID || 'YOUR_AUTOREPLY_TEMPLATE_ID',
